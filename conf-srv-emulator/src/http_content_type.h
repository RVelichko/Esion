  ...
  namespace Http
  {
    namespace Content
    {
      namespace Type
      {
        ...
        DECLARE_HTTP_CONTENT_TYPE(map, application/octet-stream)
        DECLARE_HTTP_CONTENT_TYPE(css, text/css)
        DECLARE_HTTP_CONTENT_TYPE(js, text/javascript)
        DECLARE_HTTP_CONTENT_TYPE(json, application/json)
        DECLARE_HTTP_CONTENT_TYPE(woff2, font/woff2)
