...
Rquest 4: {
  "cmd": {
    ...
    "data": {
      ...
      "skip":"< количество пропускаемых записей в списке найденных устройств >",
      "num":"< количество возвращаемых устройств >",
      "date_time_from": "< Дата time_t, от которой необходимо найти устройства >",
      "date_time_to": "< Дата time_t, по которой необходимо найти устройства >",
...
Rquest 3: {
  "cmd": {
    ...
    "data": {
      ...
      "skip": "< количество пропускаемых записей в списке найденных устройств >",
      "num": "< количество возвращаемых устройств >",
      "date_time_from": "< Дата time_t, от которой необходимо найти события >",
      "date_time_to": "< Дата события >"
    }
  }
}
```
